...
- **Library management** — scan folders of video files, browse by status, split into sub-libraries
...
- **Cleanup** — filter and bulk-delete files by duration, resolution, FPS, or date
